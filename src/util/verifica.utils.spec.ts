...
describe('verificarDestino', () => {
  ...
  it('deve retornar SAO_PAULO_RIO_JANEIRO_BH_POA_SALVADOR_RECIFE_FORTALEZA para municípios específicos de 80%', () => {
    expect(verificarDestino(7107)).toBe(Destino.SAO_PAULO_RIO_JANEIRO_BH_POA_SALVADOR_RECIFE_FORTALEZA);   
    expect(verificarDestino(3849)).toBe(Destino.SAO_PAULO_RIO_JANEIRO_BH_POA_SALVADOR_RECIFE_FORTALEZA); 
  });
