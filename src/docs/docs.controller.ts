import { Body, Controller, Delete, Get, HttpException, HttpStatus, Param, Post, Query, UploadedFile, UseGuards, UseInterceptors } from '@nestjs/common';
...
export class docsController {
  ...
  async docsFile(
    ...
    @Body() body: { SQE_ID_CODIGO: number; },
  ) {
    if (!file) {
